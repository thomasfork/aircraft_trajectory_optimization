...
COLLOCATION_ROOT_METHOD = 'legendre' # legendre or radau
...
def get_collocation_coefficients(K):
    ...
    '''
    tau = np.append(0, ca.collocation_points(K, COLLOCATION_ROOT_METHOD))
...
def get_intermediate_collocation_coefficients(K, d):
    '''
